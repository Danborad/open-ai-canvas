                ...
                <div className="space-y-6">
                    <header>
                        <div className="flex flex-wrap items-center gap-2 text-xs text-foreground/50">
                            ...
                            <span>{skill.is_private ? "仅自己可见" : "公开技能"}</span>
                            <span aria-hidden="true">/</span>
                    ...
                    <section aria-labelledby="skill-instruction-title">
                        <div className="mb-2 flex items-center justify-between gap-3">
                            ...
                            {skill.markdown_url ? (
                                <Tooltip title="打开 Markdown 原文">
                                    <a
                                        className="inline-flex size-8 items-center justify-center rounded-md text-foreground/55 hover:bg-foreground/[.06] hover:text-foreground"
                                        href={skill.markdown_url}
                                        target="_blank"
                                        rel="noreferrer"
                                        aria-label="打开 Markdown 原文"
                                    >
