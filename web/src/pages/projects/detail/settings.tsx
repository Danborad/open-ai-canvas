        ...
        <div>
            ...
            <section className="border-b border-border/70 py-4">
                <div className="mb-3 flex items-center justify-between gap-3">
                    ...
                    {styleProfile ? (
                        <span className="text-[var(--fs-label)] text-[var(--workspace-accent)]">{styleProfile.source === "user" ? "来自我的风格" : styleProfile.source === "external" ? "外部导入" : "系统预设"}</span>
                    ) : (
                ...
                <div className="flex flex-col gap-3 border-y border-border/70 py-3 lg:flex-row lg:items-center">
                    ...
                    <div className="flex shrink-0 flex-wrap gap-2">
                        ...
                        <Button
                            type={styleProfile ? "primary" : "default"}
                ...
                {styleProfile ? (
                    <div className="grid grid-cols-2 border-b border-border text-xs sm:grid-cols-5">
                ...
                {styleExecutionPlans && (styleExecutionPlans.image.warnings.length || styleExecutionPlans.video.warnings.length) ? (
                    <div className="grid gap-1 border-b border-border px-3 py-2 text-[var(--fs-label)] leading-5 text-amber-600 dark:text-amber-400">
...
function StyleMetric({ label, value }: { label: string; value: string }) {
    return (
        <div className="min-w-0 border-r border-t border-border px-3 py-2 first:border-l sm:border-t-0">
