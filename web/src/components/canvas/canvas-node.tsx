...
function NodeExternalHeader({ node, scale, dimensionLabel, active, editable, editing, draft, theme, onDraftChange, onEdit, onCommit, onCancel }: {
    ...
    return (
        <div
            ...
            style={{
                width: dimensionLabel || (modelBadgeEnabled && modelLabel) ? externalHeaderWidth : undefined,
                maxWidth: dimensionLabel || (modelBadgeEnabled && modelLabel) ? undefined : maxHeaderWidth,
