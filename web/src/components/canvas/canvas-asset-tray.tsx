            ...
            <AnimatePresence>
                {open ? (
                    ...
                    >
                        ...
                        <button
                            type="button"
                            className="absolute left-1/2 top-1 z-10 flex h-5 w-28 -translate-x-1/2 cursor-ns-resize items-center justify-center rounded-full opacity-35 transition-opacity hover:opacity-75"
                        ...
                        <div className="flex items-center justify-between gap-2 px-1 pb-2.5 pt-1.5">
                            ...
                            <motion.button
                                ...
                                className="grid size-7 shrink-0 place-items-center rounded-full border outline-none focus-visible:ring-2"
                        ...
                        <div className="flex items-center justify-between px-1 pt-2.5 text-[var(--fs-tiny)]" style={{ color: theme.node.muted }}>
                            ...
                            <span className="rounded-full border px-2 py-0.5 tabular-nums" style={{ background: theme.spatial.surface, borderColor: theme.toolbar.border }}>
        ...
        >
            {active ? (
                <motion.span
                    ...
                    className="absolute inset-0 -z-10 rounded-[var(--dock-item-radius)] border"
                    style={{ background: theme.node.panel, borderColor: theme.toolbar.border, boxShadow: `0 6px 16px ${theme.spatial.shadow}` }}
...
function AssetTrayRow({
    ...
    return (
        ...
        >
            ...
            <span className="grid size-6 place-items-center rounded-full border opacity-45 transition-opacity group-hover:opacity-90" style={{ background: theme.node.panel, borderColor: theme.toolbar.border }}>
                {icon}
            </span>
        </motion.button>
    );
