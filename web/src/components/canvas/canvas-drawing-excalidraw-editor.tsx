...
export const CanvasDrawingExcalidrawEditor = forwardRef<CanvasDrawingEditorHandle, CanvasDrawingEditorProps>(function CanvasDrawingExcalidrawEditor({ snapshot, colorScheme, onReady }, ref) {
    ...
    const initialData = snapshot && typeof snapshot === "object" ? { ...(snapshot as ExcalidrawInitialDataState), scrollToContent: true } : { elements: [], appState: { viewBackgroundColor: "#ffffff" }, files: {}, scrollToContent: true };
