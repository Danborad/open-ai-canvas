        ...
        <div>
            ...
            {user ? (
                    ...
                    content={
                        <div className="w-[232px] py-0.5">
                            ...
                            <div className="border-y border-border/65 py-2">
                                <AppChangelogButton
                                    className="flex h-8 w-full items-center gap-2 rounded px-2 text-[var(--fs-label)] text-foreground/58 hover:bg-foreground/[.055] hover:text-foreground [&_svg]:size-3.5"
                                    showLabel
                                    showVersion
                            ...
                            <button type="button" className="flex h-9 w-full items-center gap-2 rounded px-2 text-xs text-foreground/55 hover:bg-foreground/[.055] hover:text-foreground" onClick={() => void handleLogout()}>
                ...
                >
                    <button
                        type="button"
                        className={cn("flex min-h-10 w-full min-w-0 items-center overflow-hidden rounded-md text-left transition-colors hover:bg-foreground/[.045]", accountClassName)}
